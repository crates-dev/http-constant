...
pub const SESSION_LOGIN_TIME_KEY: &'static str = "login_time";

/// The session data key used to store the last access timestamp.
pub const SESSION_LAST_ACCESS_TIME_KEY: &'static str = "last_access_time";

/// The session data key used to store the client's IP address.
pub const SESSION_IP_ADDRESS_KEY: &'static str = "ip_address";

/// The session data key used to store the client's user agent string.
pub const SESSION_USER_AGENT_KEY: &'static str = "user_agent";
...
pub const SESSION_LANGUAGE_KEY: &'static str = "language";

/// The session data key used to store the user's timezone.
pub const SESSION_TIMEZONE_KEY: &'static str = "timezone";
...
pub const SESSION_STATE_DESTROYED: &'static str = "destroyed";
...
pub const SESSION_ID_CHARSET: &'static str =
    "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";

/// The byte representation of the session ID character set.
pub const SESSION_ID_CHARSET_BYTES: &'static [u8] = SESSION_ID_CHARSET.as_bytes();
...
pub const SESSION_FLASH_SUCCESS: &'static str = "success";
/// The type for an error flash message.
pub const SESSION_FLASH_ERROR: &'static str = "error";
/// The type for a warning flash message.
pub const SESSION_FLASH_WARNING: &'static str = "warning";
/// The type for an informational flash message.
pub const SESSION_FLASH_INFO: &'static str = "info";

/// The name of the "remember me" cookie.
pub const SESSION_REMEMBER_ME_COOKIE_NAME: &'static str = "remember_me";
...
pub const SESSION_FINGERPRINT_SEPARATOR: &'static str = "|";
